   ...
   if (mysqli_connect_error()){
    ...
    $query="SELECT 'email' FROM users where email='".mysqli_real_escape_string($link,$email)."'";
        $result=mysqli_query($link,$query);
            ...
            if(mysqli_query($link,$query)){echo '<script>alert("User Sign Up Success")</script>';}
            //mysqli_query($link,$query);
            //echo $query;
           //$query= "INSERT INTO `users`(`email`, `password`) VALUES (BMW,)";
        }
    }
            ...
            <div  class="row h-100 justify-content-center align-items-center">
                ...
                <form method="post"  >
                    ...
                    <button type="submit" class="btn btn-primary th">Submit</button>
                     ...
                     <button id="myButton" class="btn btn-dark th2">Log In</button>
